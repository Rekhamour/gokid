...
import com.gokids.yoda_tech.gokidsapp.settings.fragment.AgeFragment;
import com.gokids.yoda_tech.gokidsapp.settings.fragment.AllergyFragment;
import com.gokids.yoda_tech.gokidsapp.settings.fragment.AnotherFragment;
...
import com.gokids.yoda_tech.gokidsapp.settings.fragment.GenderFragment;
import com.gokids.yoda_tech.gokidsapp.settings.model.CustomViewPager;
...
public void handleContinueclick(String flag){
    ...
    private void updateKidsdetails() {
        ...
        String url= Urls.BASE_URL+"api/updateKidProfile/kidID/"+AddKidsActivity.KidId+"/age/"+AddKidsActivity.mAge+"/gender/-/specialNeed/"+jsonArray.toString();
