package com.gokids.yoda_tech.gokidsapp.shop.activity.adapter;
...
public class ShoplistAdapter extends RecyclerView.Adapter<ShoplistAdapter.MyViewHolder> {
    ...
    public ShoplistAdapter(Context ctx, ArrayList<MainBean> list){
        this.list = list;
        this.ctx= ctx;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.shop_list_row, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.name.setText(m.getShopName());
