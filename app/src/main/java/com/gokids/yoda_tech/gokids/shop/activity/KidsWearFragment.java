...
public class KidsWearFragment extends Fragment implements FoodAdapter.ItemClickCallback,SwipeRefreshLayout.OnRefreshListener {
    ...
    public static KidsWearFragment newInstance(){
        KidsWearFragment itemOnFragment = new KidsWearFragment();
    ...
    public int getTotalRestaurants(final String category) {
        Ion.with(getActivity())
                .load("http://52.77.82.210/api/categoryTotalCount/category/CLS2/subCategory/CAT2")
                .asJsonObject()
    ...
    public ArrayList<MainBean> getRestaurants(final String category, final String name, final double lat, final double longi, final String sortBy, final int start, final int count){
        ...
        String ak= "api/viewAllShops/latitude/1.301949/longitude/103.839829/category/CAT/limitStart/0/count/5/sortBy/Distance";
        // System.out.println(url);
        String PATH= BASE_URL + "api/viewAllShops/latitude/"+latlon.getLatitude()+"/longitude/"+latlon.getLongitude()+"/category/CAT2/limitStart/"+ mCount+"/count/"+count+"/sortBy/Distance/searchBy/-";
        Log.e(TAG,"path"+PATH);
