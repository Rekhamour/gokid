...
public class SummerEntertainment extends Fragment implements FoodAdapter.ItemClickCallback,SwipeRefreshLayout.OnRefreshListener {
    ...
    public static SummerEntertainment newInstance(String tabcategory, String tabTitle){
        SummerEntertainment itemOnFragment = new SummerEntertainment();
