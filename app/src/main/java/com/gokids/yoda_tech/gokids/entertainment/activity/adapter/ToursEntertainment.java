...
public class ToursEntertainment extends Fragment implements FoodAdapter.ItemClickCallback,SwipeRefreshLayout.OnRefreshListener {
    ...
    public static ToursEntertainment newInstance(String tabcategory, String tabTitle){
        ToursEntertainment itemOnFragment = new ToursEntertainment();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (item.getItemId() == R.id.filter_search) {PopupMenu popup = new PopupMenu(getActivity(), getActivity().findViewById(R.id.filter_search));
