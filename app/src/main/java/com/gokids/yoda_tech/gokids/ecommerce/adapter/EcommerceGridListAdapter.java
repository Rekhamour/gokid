...
public class EcommerceGridListAdapter extends BaseAdapter {
    ...
    public EcommerceGridListAdapter(Context c, ArrayList<Allergy> allergies) {
        this.mContext = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        customView.display(position,allergy.get(position).getDispText(),allergy.get(position).getDrawableID(),allergy.get(position).isSelected());
