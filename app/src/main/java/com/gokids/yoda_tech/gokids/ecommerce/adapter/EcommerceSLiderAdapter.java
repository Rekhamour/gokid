...
public class EcommerceSLiderAdapter extends PagerAdapter {
    ...
    public EcommerceSLiderAdapter(Context context, ArrayList<Integer> images) {
    ...
    public Object instantiateItem(ViewGroup view, final int position) {
        ...
        myImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Utils.openfullimageDrawable(context, position, images);
            }
        });
