 ...
 * Created by sab99r
 */
public class EcommercCartListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  static   List<ShopifyProductBean> list;
    ...
    * */
    ...
    public EcommercCartListAdapter(Context context, ArrayList<ShopifyProductBean> list) {
        EcommercCartListAdapter.context = context;
        EcommercCartListAdapter.list = list;
