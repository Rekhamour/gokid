...
// Defaults, may need to link this into theme settings
        int arcColor = res.getColor(R.color.grey);
        int progressColor = res.getColor(R.color.red_500);
        int thumbHalfheight = 0;
        int thumbHalfWidth = 0;
        mThumb = res.getDrawable(R.drawable.thumb_bg);
...
// Draw the arcs
        ...
        //  Integer[] colorlist = new Integer[]{Color.parseColor("#74d1d8"),Color.parseColor("#f2b97b"),Color.parseColor("#f6686a"),Color.parseColor("#77c99e")};
        // Color[] colorlist = new Color[]{getResources().getColor(Color.parseColor(R.color.index_blue),null),getResources().getColor(R.color.index_blue,null)};
        // Color b= getResources().getColor()
     /*   for(int i = 0,j= 0;j<4 && i<=360;) {
            final int strokeWidth = 40;

            Paint paint = new Paint();
            int START_ANGLE_POINT = i;
            int mangle = START_ANGLE_POINT+90;
            ...
            RectF rect = new RectF(strokeWidth, strokeWidth, 300+strokeWidth, 270+ strokeWidth);
            float radius = 100;
           // arcBottomHeight = radius * (float) (1 - Math.cos(angle / 180 * Math.PI));
            ...
            if(i>89 && i<92)
                    canvas.drawArc(rect,i, i+2, false, paint);
            if(i>179 && i<182)
                canvas.drawArc(rect, i,i+2, false, paint);
            if(i>269 && i<272)
                canvas.drawArc(rect, i,i+2, false, paint);
...
// Draw the thumb nail
  ...
  /*      Integer[] colorlist = new Integer[]{Color.RED,Color.WHITE,Color.YELLOW,Color.BLUE};
        for(int i = 0,j= 0;j<4 && i<=360;j++) {
            final int strokeWidth = 40;
            ...
            paint.setStrokeWidth(strokeWidth);
            //Circle color
            paint.setColor(colorlist[j]);
            RectF rect = new RectF(strokeWidth, strokeWidth, 200 + strokeWidth, 200 + strokeWidth);
            float radius = 100;
            // arcBottomHeight = radius * (float) (1 - Math.cos(angle / 180 * Math.PI));

            canvas.drawArc(rect, START_ANGLE_POINT, 90, false, paint);
