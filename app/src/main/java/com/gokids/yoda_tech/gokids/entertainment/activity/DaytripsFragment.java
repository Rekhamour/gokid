...
public class DaytripsFragment extends Fragment {
   ...
   public static Context ctx;
    ...
    public static String TAG = "DaytripsFragment";
    private int total;
    ...
    public static DaytripsFragment newInstance(String tabcategory, String tabTitle){
        DaytripsFragment itemOnFragment = new DaytripsFragment();
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                      //  load(0);
                        ...
                        getRestaurants(dte,"-",latlon.getLatitude(),latlon.getLongitude(),"Distance",0,0);
